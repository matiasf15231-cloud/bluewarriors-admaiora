...
const AchievementsSection = () => {
  ...
  return (
    <section id="logros" className="py-20 bg-gradient-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {stats.map((stat, index) => {
            ...
            return (
              <Card key={index} className="text-center hover:shadow-card transition-all duration-smooth border-primary/10 hover:border-primary/30 group">
                <CardContent className="p-6">
        ...
        <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8 border border-primary/20">
          ...
          <div className="text-center space-y-4">
            ...
            <div>
              <h4 className="text-xl font-bold text-foreground mb-2">Reconocimientos Especiales</h4>
              <p className="text-muted-foreground">
                Más allá de las posiciones, hemos sido reconocidos por nuestro espíritu de equipo, 
                innovación y adherencia a los valores fundamentales de FIRST.
              </p>
            </div>
          </div>
        </div>
